import { defineComponent, ref, computed, resolveComponent, unref, withCtx, openBlock, createBlock, createVNode, toDisplayString, createCommentVNode, Fragment, renderList, useSSRContext } from "vue";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        title: selectedUser.value?.isActive ? "Deactivate User" : "Activate User",
        message: selectedUser.value?.isActive ? "Are you sure you want to deactivate this user? They will not be able to log in or use the platform." : "Are you sure you want to activate this user? They will regain access to the platform.",
        confirmText: selectedUser.value?.isActive ? "Deactivate" : "Activate",
        type: selectedUser.value?.isActive ? "danger" : "info",
...
//# sourceMappingURL=index-By9Ml9cy.js.map
