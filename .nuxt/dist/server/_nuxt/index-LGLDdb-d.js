import { ref, defineComponent, computed, unref, withCtx, openBlock, createBlock, createVNode, createCommentVNode, toDisplayString, createTextVNode, withDirectives, vModelText, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderComponent, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderClass } from "vue/server-renderer";
              ...
              selectedRequest.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "grid grid-cols-2 gap-4" }, [
                  createVNode("div", { class: "bg-slate-50 p-4 rounded-xl border border-slate-100" }, [
                    ...
                    createVNode("div", { class: "text-xs text-slate-500 mt-1" }, toDisplayString(selectedRequest.value.budgetSignal?.flexibility), 1)
                  ]),
                  createVNode("div", { class: "bg-slate-50 p-4 rounded-xl border border-slate-100" }, [
...
//# sourceMappingURL=index-LGLDdb-d.js.map
