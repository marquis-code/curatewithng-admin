      ...
      if (unref(loading)) {
        ...
        ssrRenderList(filteredUsers.value, (user) => {
          ...
          if (user.avatar) {
            ...
            _push(`<span>${ssrInterpolate(((_a = user.firstName) == null ? void 0 : _a.charAt(0)) || ((_b = user.email) == null ? void 0 : _b.charAt(0)))}</span>`);
          }
          ...
          if (_push2) {
            if (selectedUser.value) {
              ...
              if (selectedUser.value.avatar) {
                ...
                _push2(`<span${_scopeId}>${ssrInterpolate(((_a = selectedUser.value.firstName) == null ? void 0 : _a.charAt(0)) || ((_b = selectedUser.value.email) == null ? void 0 : _b.charAt(0)))}</span>`);
              }
...
//# sourceMappingURL=index-Do9V0u9i.mjs.map
