import { defineComponent, ref, computed, unref, withCtx, openBlock, createBlock, createVNode, toDisplayString, createCommentVNode, useSSRContext } from 'file:///Users/marquis/curatewithng/admin/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><select class="input-field !py-2 !w-48"><option value=""${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "") : ssrLooseEqual(statusFilter.value, "")) ? " selected" : ""}>All Statuses</option><option value="PENDING"${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "PENDING") : ssrLooseEqual(statusFilter.value, "PENDING")) ? " selected" : ""}>Pending</option><option value="COMPLETED"${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "COMPLETED") : ssrLooseEqual(statusFilter.value, "COMPLETED")) ? " selected" : ""}>Completed</option><option value="REJECTED"${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "REJECTED") : ssrLooseEqual(statusFilter.value, "REJECTED")) ? " selected" : ""}>Rejected</option></select></div><div class="overflow-x-auto"><table class="w-full text-left border-collapse"><thead><tr class="bg-white border-b border-slate-200 text-sm font-semibold text-slate-600"><th class="p-4">Vendor</th><th class="p-4">Amount</th><th class="p-4">Status</th><th class="p-4">Requested At</th><th class="p-4 text-right">Actions</th></tr></thead><tbody>`);
      if (loading.value) {
        _push(`<!--[-->`);
        ssrRenderList(5, (i) => {
...
//# sourceMappingURL=index-Ds-GVwLd.mjs.map
