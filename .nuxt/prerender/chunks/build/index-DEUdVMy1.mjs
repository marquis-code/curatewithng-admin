import { defineComponent, ref, computed, unref, withCtx, openBlock, createBlock, createVNode, toDisplayString, createTextVNode, createCommentVNode, Fragment, renderList, useSSRContext } from 'file:///Users/marquis/curatewithng/admin/node_modules/vue/index.mjs';
...
import { Search, Package, Calendar, CreditCard, User, Gift, Truck, MapPin, ShoppingBag, Image } from 'file:///Users/marquis/curatewithng/admin/node_modules/lucide-vue-next/dist/cjs/lucide-vue-next.js';
    ...
    const filteredOrders = computed(() => {
      ...
      if (searchQuery.value) {
        ...
        result = result.filter(
          (o) => {
            var _a, _b;
            return ((_a = o.orderNumber) == null ? void 0 : _a.toLowerCase().includes(q)) || ((_b = o._id) == null ? void 0 : _b.toLowerCase().includes(q));
          }
        );
      }
      return result;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(filteredOrders.value, (order) => {
          ...
          _push(`<tr class="border-b border-slate-100 hover:bg-slate-50 transition-colors"><td class="p-4 font-medium text-slate-900 font-mono text-sm">${ssrInterpolate(order.orderNumber || `#${(_a = order._id) == null ? void 0 : _a.substring(0, 8).toUpperCase()}`)}</td><td class="p-4"><div class="flex flex-col"><span class="font-medium text-slate-900">${ssrInterpolate((_b = order.userId) == null ? void 0 : _b.firstName)} ${ssrInterpolate((_c = order.userId) == null ? void 0 : _c.lastName)}</span><span class="text-xs text-slate-500">${ssrInterpolate(((_d = order.userId) == null ? void 0 : _d.email) || "Guest User")}</span></div></td><td class="p-4"><div class="flex flex-col"><span class="font-medium text-slate-700">${ssrInterpolate(((_e = order.recipient) == null ? void 0 : _e.name) || "N/A")}</span><span class="text-xs text-slate-500">${ssrInterpolate(((_f = order.recipient) == null ? void 0 : _f.phone) || "")}</span></div></td><td class="p-4"><div class="flex flex-col"><span class="font-bold text-slate-900">\u20A6${ssrInterpolate(((_g = order.totalAmount) == null ? void 0 : _g.toLocaleString()) || 0)}</span><span class="text-[10px] text-slate-400 font-medium uppercase tracking-wider">${ssrInterpolate(((_h = order.items) == null ? void 0 : _h.length) || 0)} Items</span></div></td><td class="p-4"><span class="${ssrRenderClass([order.paymentStatus === "PAID" ? "bg-emerald-100 text-emerald-800 border-emerald-200" : "bg-amber-100 text-amber-800 border-amber-200", "text-[10px] uppercase font-bold px-2 py-0.5 rounded border"])}">${ssrInterpolate(order.paymentStatus || "UNPAID")}</span></td><td class="p-4"><span class="${ssrRenderClass(getStatusClass(order.status))}">${ssrInterpolate(order.status || "PENDING")}</span></td><td class="p-4 text-xs font-medium text-slate-500">${ssrInterpolate(new Date(order.createdAt).toLocaleDateString())}</td><td class="p-4 text-right"><button class="text-primary-600 hover:text-primary-700 font-medium px-3 py-1 rounded hover:bg-primary-50 transition-colors border border-transparent hover:border-primary-100"> Inspect </button></td></tr>`);
        });
        _push(`<!--]-->`);
      }
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (selectedOrder.value) {
              _push2(`<div class="space-y-6 pb-12"${_scopeId}><div class="bg-primary-50 p-6 rounded-2xl border border-primary-100 text-center relative overflow-hidden"${_scopeId}><div class="absolute inset-0 bg-gradient-to-br from-primary-100/50 to-transparent pointer-events-none"${_scopeId}></div><div class="relative z-10"${_scopeId}><div class="text-xs text-primary-600 font-bold uppercase tracking-widest mb-2"${_scopeId}>Total Amount</div><div class="text-4xl font-heading font-black text-primary-900"${_scopeId}>\u20A6${ssrInterpolate(((_a = selectedOrder.value.totalAmount) == null ? void 0 : _a.toLocaleString()) || 0)}</div><div class="mt-4 flex items-center justify-center gap-2"${_scopeId}><span class="${ssrRenderClass(getStatusClass(selectedOrder.value.status))}"${_scopeId}>${ssrInterpolate(selectedOrder.value.status || "PENDING")}</span><span class="${ssrRenderClass([selectedOrder.value.paymentStatus === "PAID" ? "bg-emerald-100 text-emerald-800 border-emerald-200" : "bg-amber-100 text-amber-800 border-amber-200", "text-[10px] uppercase font-bold px-2.5 py-1 rounded-full border"])}"${_scopeId}>${ssrInterpolate(selectedOrder.value.paymentStatus || "UNPAID")}</span></div></div></div><div class="grid grid-cols-2 gap-4"${_scopeId}><div class="bg-white p-4 rounded-xl border border-slate-200 shadow-sm"${_scopeId}><div class="text-xs text-slate-400 font-bold mb-1 uppercase tracking-wider flex items-center gap-2"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Package), { class: "w-3 h-3" }, null, _parent2, _scopeId));
              _push2(` Order ID </div><div class="font-mono font-bold text-slate-900 text-sm"${_scopeId}>${ssrInterpolate(selectedOrder.value.orderNumber || `#${(_b = selectedOrder.value._id) == null ? void 0 : _b.substring(0, 12).toUpperCase()}`)}</div></div><div class="bg-white p-4 rounded-xl border border-slate-200 shadow-sm"${_scopeId}><div class="text-xs text-slate-400 font-bold mb-1 uppercase tracking-wider flex items-center gap-2"${_scopeId}>`);
              ...
              _push2(` Financial Split </h5><div class="bg-slate-50 p-4 rounded-xl border border-slate-100 space-y-3 text-sm text-slate-600"${_scopeId}><div class="flex justify-between items-center"${_scopeId}><span${_scopeId}>Vendor Payout</span><span class="font-bold text-slate-900"${_scopeId}>\u20A6${ssrInterpolate(((_c = selectedOrder.value.vendorAmount) == null ? void 0 : _c.toLocaleString()) || 0)}</span></div><div class="flex justify-between items-center"${_scopeId}><span${_scopeId}>Platform Commission</span><span class="font-bold text-primary-600"${_scopeId}>\u20A6${ssrInterpolate(((_d = selectedOrder.value.platformFee) == null ? void 0 : _d.toLocaleString()) || 0)}</span></div>`);
              ...
              _push2(` Customer (Buyer) </h5><div class="text-sm text-slate-600 bg-white shadow-sm p-4 rounded-xl border border-slate-200 space-y-2"${_scopeId}><div class="font-bold text-slate-900 text-base"${_scopeId}>${ssrInterpolate((_e = selectedOrder.value.userId) == null ? void 0 : _e.firstName)} ${ssrInterpolate((_f = selectedOrder.value.userId) == null ? void 0 : _f.lastName)}</div><div class="text-slate-500 text-xs"${_scopeId}>${ssrInterpolate((_g = selectedOrder.value.userId) == null ? void 0 : _g.email)}</div></div></div>`);
              ...
              _push2(` Order Items (${ssrInterpolate(((_h = selectedOrder.value.items) == null ? void 0 : _h.length) || 0)}) </h5><div class="space-y-3"${_scopeId}><!--[-->`);
              ssrRenderList(selectedOrder.value.items, (item) => {
                ...
                if ((_b2 = (_a2 = item.giftId) == null ? void 0 : _a2.images) == null ? void 0 : _b2[0]) {
                ...
                _push2(`</div><div class="flex-1 min-w-0"${_scopeId}><div class="font-bold text-slate-900 truncate"${_scopeId}>${ssrInterpolate(((_c2 = item.giftId) == null ? void 0 : _c2.name) || "Unknown Gift Item")}</div><div class="text-xs text-slate-500 mt-0.5"${_scopeId}><span class="font-mono bg-slate-100 px-1 rounded border border-slate-200"${_scopeId}>Qty: ${ssrInterpolate(item.quantity)}</span> \xD7 \u20A6${ssrInterpolate(((_d2 = item.unitPrice) == null ? void 0 : _d2.toLocaleString()) || 0)}</div></div><div class="font-black text-slate-900 text-right"${_scopeId}> \u20A6${ssrInterpolate(((_e2 = item.unitPrice * item.quantity) == null ? void 0 : _e2.toLocaleString()) || 0)}</div></div>`);
              });
              _push2(`<!--]--></div></div>`);
              if (((_i = selectedOrder.value.timeline) == null ? void 0 : _i.length) > 0) {
              ...
              selectedOrder.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "bg-primary-50 p-6 rounded-2xl border border-primary-100 text-center relative overflow-hidden" }, [
                  ...
                  createVNode("div", { class: "relative z-10" }, [
                    ...
                    createVNode("div", { class: "text-4xl font-heading font-black text-primary-900" }, "\u20A6" + toDisplayString(((_j = selectedOrder.value.totalAmount) == null ? void 0 : _j.toLocaleString()) || 0), 1),
                ...
                createVNode("div", { class: "grid grid-cols-2 gap-4" }, [
                  createVNode("div", { class: "bg-white p-4 rounded-xl border border-slate-200 shadow-sm" }, [
                    ...
                    createVNode("div", { class: "font-mono font-bold text-slate-900 text-sm" }, toDisplayString(selectedOrder.value.orderNumber || `#${(_k = selectedOrder.value._id) == null ? void 0 : _k.substring(0, 12).toUpperCase()}`), 1)
                  ]),
                  createVNode("div", { class: "bg-white p-4 rounded-xl border border-slate-200 shadow-sm" }, [
                    createVNode("div", { class: "text-xs text-slate-400 font-bold mb-1 uppercase tracking-wider flex items-center gap-2" }, [
                ...
                createVNode("div", { class: "space-y-4 pt-2" }, [
                  ...
                  createVNode("div", { class: "bg-slate-50 p-4 rounded-xl border border-slate-100 space-y-3 text-sm text-slate-600" }, [
                    createVNode("div", { class: "flex justify-between items-center" }, [
                      ...
                      createVNode("span", { class: "font-bold text-slate-900" }, "\u20A6" + toDisplayString(((_l = selectedOrder.value.vendorAmount) == null ? void 0 : _l.toLocaleString()) || 0), 1)
                    ]),
                    createVNode("div", { class: "flex justify-between items-center" }, [
                      createVNode("span", null, "Platform Commission"),
                      createVNode("span", { class: "font-bold text-primary-600" }, "\u20A6" + toDisplayString(((_m = selectedOrder.value.platformFee) == null ? void 0 : _m.toLocaleString()) || 0), 1)
                    ]),
                ...
                createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4 pt-2" }, [
                  createVNode("div", { class: "space-y-3 border-t border-slate-100 pt-4" }, [
                    ...
                    createVNode("div", { class: "text-sm text-slate-600 bg-white shadow-sm p-4 rounded-xl border border-slate-200 space-y-2" }, [
                      createVNode("div", { class: "font-bold text-slate-900 text-base" }, toDisplayString((_n = selectedOrder.value.userId) == null ? void 0 : _n.firstName) + " " + toDisplayString((_o = selectedOrder.value.userId) == null ? void 0 : _o.lastName), 1),
                      createVNode("div", { class: "text-slate-500 text-xs" }, toDisplayString((_p = selectedOrder.value.userId) == null ? void 0 : _p.email), 1)
                    ])
                  ]),
                ...
                createVNode("div", { class: "space-y-4 pt-4 border-t border-slate-100" }, [
                  createVNode("h5", { class: "text-sm font-bold text-slate-900 uppercase tracking-widest flex items-center gap-2 border-b border-slate-100 pb-2" }, [
                    ...
                    createTextVNode(" Order Items (" + toDisplayString(((_q = selectedOrder.value.items) == null ? void 0 : _q.length) || 0) + ") ", 1)
                  ]),
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(selectedOrder.value.items, (item) => {
                      ...
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "w-12 h-12 rounded-lg bg-slate-100 overflow-hidden flex-shrink-0 border border-slate-200" }, [
                          ((_b2 = (_a2 = item.giftId) == null ? void 0 : _a2.images) == null ? void 0 : _b2[0]) ? (openBlock(), createBlock("img", {
                            key: 0,
                        ...
                        createVNode("div", { class: "flex-1 min-w-0" }, [
                          createVNode("div", { class: "font-bold text-slate-900 truncate" }, toDisplayString(((_c2 = item.giftId) == null ? void 0 : _c2.name) || "Unknown Gift Item"), 1),
                          createVNode("div", { class: "text-xs text-slate-500 mt-0.5" }, [
                            ...
                            createTextVNode(" \xD7 \u20A6" + toDisplayString(((_d2 = item.unitPrice) == null ? void 0 : _d2.toLocaleString()) || 0), 1)
                          ])
                        ]),
                        createVNode("div", { class: "font-black text-slate-900 text-right" }, " \u20A6" + toDisplayString(((_e2 = item.unitPrice * item.quantity) == null ? void 0 : _e2.toLocaleString()) || 0), 1)
                      ]);
                    }), 128))
                  ])
                ]),
                ((_r = selectedOrder.value.timeline) == null ? void 0 : _r.length) > 0 ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: "space-y-4 pt-4 border-t border-slate-100"
                }, [
...
//# sourceMappingURL=index-DEUdVMy1.mjs.map
